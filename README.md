...
There are two macro files, [issue macro](docs/addsheets_issuemacro.csv.md) and [country macro](docs/addsheets_countrymacro.csv). The former lists the opinion items used in the analyses, while the latter provides information about the countries. Most notably, it features there additional variables gathered from outside sources: (a) party institutionalization index and (b) media heterogeneity index, both of which is an aggregation of V-Dem indices from 2000 to 2017 (see this [link](https://www.v-dem.net/en/data/data/) for the data), and (c) the effective number of parties. I mostly used Michael Gallagher's files ([here](https://www.tcd.ie/Political_Science/people/michael_gallagher/ElSystems/index.php)) for this, though I hand-calculated some of the missing countries.
